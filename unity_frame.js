...
(function () {
  ...
  window.firebase = {
    ...
    analytics: () => ({
      ...
      firebaseLogEvent:    (n, p) => console.log('[Unity] logEvent:', n, p),
      firebaseSetCurrentScreen:(s)    => console.log('[Unity] screen:', s),
      firebaseSetUserId:       (id)   => console.log('[Unity] userId:', id),
    }),
    app:  () => window.firebase,
